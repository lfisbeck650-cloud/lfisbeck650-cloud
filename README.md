...
💻 **Low-Level Programming | C & Assembly | Retro Console Development**
🧠 Exploring how computers work from the **hardware level up**
🎮 Developing for classic platforms like the **NES, Nintendo DS and Nintendo Wii**
🔧 Learning by building real software close to the hardware

---

## 🧠 About Me

* 💻 Learning **C programming and Assembly**
* ⚙️ Focused on **low-level and systems programming**
* 🎮 Developing software for the **NES, Nintendo DS and Nintendo Wii**
...
* 🧠 Low-level CPU and memory experiments
* 🎮 NES homebrew
* 🎮 Nintendo DS homebrew
* 🏠 Nintendo Wii homebrew
* 🔌 Embedded programming
* 🧰 Hardware experiments
* 🕹️ Retro console development

---

## 🌍 Goals

* Become highly proficient in **C and Assembly**
* Understand **CPU architecture and machine code**
